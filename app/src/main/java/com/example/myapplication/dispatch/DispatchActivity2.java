...
public class DispatchActivity2 extends AppCompatActivity {
    ...
    private void findView() {
        Toolbar activity_dispatch_toolbar = findViewById(R.id.activity_dispatch2_toolbar);
        activity_dispatch_toolbar.setTitleTextColor(Color.WHITE);
        activity_dispatch_toolbar.setTitle("事件分发2");
        ...
        BadFragmentAdapter adapter = new BadFragmentAdapter(getSupportFragmentManager());
        ViewPager activity_dispatch2_viewpager = findViewById(R.id.activity_dispatch2_viewpager);
        activity_dispatch2_viewpager.setAdapter(adapter);
    }
