    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            switch (wifiState) {
                case WifiManager.WIFI_STATE_DISABLED:
                    NetworkSingleton.getInstance().setWifiEnabled(false);
                    break;
                ...
                case WifiManager.WIFI_STATE_ENABLED:
                    NetworkSingleton.getInstance().setWifiEnabled(true);
                    break;
        ...
        if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            if (null != parcelableExtra) {
                ...
                if (isConnected) {
                    NetworkSingleton.getInstance().setWifi(true);
                } else {
                    NetworkSingleton.getInstance().setWifi(false);
                }
            }
        }
            ...
            if (activeNetwork != null) { // connected to the internet
                if (activeNetwork.isConnected()) {
                    if (activeNetwork.getType() == ConnectivityManager.TYPE_WIFI) {
                        ...
                        NetworkSingleton.getInstance().setMobile(true);
                ...
                Log.e(TAG, "当前没有网络连接，请确保你已经打开网络 ");
                NetworkSingleton.getInstance().setWifi(false);
                NetworkSingleton.getInstance().setMobile(false);
                NetworkSingleton.getInstance().setConnected(false);
            }
        }
    }
}
