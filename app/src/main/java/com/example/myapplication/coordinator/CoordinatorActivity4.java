...
public class CoordinatorActivity4 extends AppCompatActivity {
    ...
    private void findviews() {
        TextView textView1 = (TextView) findViewById(R.id.activity_coordinator4_tv1);
        TextView textView2 = (TextView) findViewById(R.id.activity_coordinator4_tv2);
        Toolbar toolbar = (Toolbar) findViewById(R.id.activity_coordinator4_toolbar);
        toolbar.setTitle("协调布局4");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CoordinatorActivity4.this.finish();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.nextmenu_next:
                Intent intent=new Intent(this,CoordinatorActivity5.class);
