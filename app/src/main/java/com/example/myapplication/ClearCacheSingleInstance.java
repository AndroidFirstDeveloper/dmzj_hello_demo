...
public class ClearCacheSingleInstance {

    private ClearCacheSingleInstance() {

    }

    public static ClearCacheSingleInstance getInstance() {
        return ClearCacheInner.instance;
    }

    private static class ClearCacheInner {
        private static final ClearCacheSingleInstance instance = new ClearCacheSingleInstance();
    }
